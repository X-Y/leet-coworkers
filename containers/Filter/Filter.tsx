...
const Filter: React.FC<Props> = ({
  filterByOptions = filterByOptionsDefault,
  ...
  const onChooseCityChange = (value: string) => {
  ...
  const cityOptions = {
    [""]: "none",
    ...Object.fromEntries(cities.map((one) => [one, one])),
  };
  return (
    <>
      <Dropdown
        id="control-filter-by"
        label="Filter By"
